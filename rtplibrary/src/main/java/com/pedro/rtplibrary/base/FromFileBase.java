...
public abstract class FromFileBase
     ...
     */
    public boolean prepareVideo(String filePath, int bitRate, int rotation, int videoWidth, int videoHeight) throws IOException {
        videoPath = filePath;
        ...
        return videoEncoder.prepareVideoEncoder(videoWidth, videoHeight, 30,
